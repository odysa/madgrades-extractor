...
public class DirSection {
    ...
    public Set<Instructor> getInstructorsSet() {
        var instrSet = new HashSet<Instructor>();
        instructors.keySet().forEach(key -> {
            instrSet.add(new Instructor(key, instructors.get(key)));
        });
        return instrSet;
    }
